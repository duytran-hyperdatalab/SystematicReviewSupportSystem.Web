...
This document provides technical details for the [CandidatePaper](file:///d:/Capstone-project/be/SRSS/SRSS.IAM/SRSS.IAM.Repositories/Entities/CandidatePaper.cs#6-26) API, part of the Systematic Review Support System (SRSS). This API manages the "Snowballing" candidate pool—references extracted from source papers during the Identification phase.
...
enum CandidateStatus {
  ...
  Imported = 2,   // Already exists in current project
  Duplicate = 3,  // Multiple candidates refer to the same paper
  Processed = 4,  // Automated matching complete
  Added = 5,      // Manually added to project dataset (Promoted)
}
```
...
### Response
- **DTO**: [PaperWithCandidateDto](file:///d:/Capstone-project/be/SRSS/SRSS.IAM/SRSS.IAM.Services/CandidatePaperService/DTOs/PaperWithCandidateDto.cs#3-20)
  ```typescript
