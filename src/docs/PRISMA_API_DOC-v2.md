...
- **Body**:
  ...
  ```
- **Logic**: 
    - **Stage 0 (Identification)**: The root node of the diagram.
    - **Stage 1 (Identified)**: Scans [ImportBatch](file:///d:/Capstone-project/be/SRSS/SRSS.IAM/SRSS.IAM.Repositories/Entities/ImportBatch.cs#5-21) for sources.
    - **Stage 2 (Duplicates)**: Includes mandatory breakdown with labels `Duplicate records removed`, `Records marked ineligible`, and `Records removed other reasons`.
    - **Exclusion Reasons**: Scans [ScreeningDecision](file:///d:/Capstone-project/be/SRSS/SRSS.IAM/SRSS.IAM.Repositories/Entities/ScreeningDecision.cs#10-26) for reason counts.
